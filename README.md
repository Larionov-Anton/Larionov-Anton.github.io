...
<div class="about__row">
	...
	<div class="about__description">
		...
		<p>Из языков и технологий знаю:</p>
			<ul>
			<li> <span>HTML</span> - DOM, теги, атрибуты, семантика </li> 
			<li> <span>CSS</span> - БЭМ, селекторы, свойства, классы, псевдоклассы, псевдоэлементы, каскадирование, наследование, приоритет, медиазапросы  </li> 
			<li> <span>SCSS</span> - переменные, вложенность, фрагментирование, миксины, расширение, мат.операторы</li> 
