...
<div class="about__row">
	...
	<div class="about__description">
		...
		<p>Из языков и технологий знаю:</p>
			<ul>
			<li> HTML - DOM, теги, атрибуты, семантика </li> 
			<li> CSS - БЭМ, селекторы, свойства, классы, псевдоклассы, псевдоэлементы, каскадирование, наследование, приоритет, медиазапросы  </li> 
			<li> SCSS - переменные, вложенность, фрагментирование, миксины, расширение, мат.операторы</li> 
			<li> JavaScript -  </li> 
			<li> TypeScript -  </li> 
			<li> React -  </li> 
			<li> Redux Toolkit -  </li> 
